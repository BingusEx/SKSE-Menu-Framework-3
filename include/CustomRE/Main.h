...
#define EXCLUSIVE_SKYRIM_FLAT_SSE
namespace CustomRE
{
    class NiNode;
	class NiCamera;
    ...
    public:
		...
		// members
		RE::BSTCommonScrapHeapMessageQueue<BSPackedTask> queue;       // 00
	...
	class Main :
#if defined(EXCLUSIVE_SKYRIM_FLAT_SSE)
        public RE::BSTEventSink<PositionPlayerEvent>,  // 00
        public RE::BSTEventSink<BSGamerProfileEvent>   // 08
#else
		public BSTEventSink<PositionPlayerEvent>  // 00
#endif
	{
    public:
        inline static constexpr auto RTTI = RE::RTTI_Main;
        inline static constexpr auto VTABLE = RE::VTABLE_Main;

		~Main() override;  // 00

		// override (BSTEventSink<PositionPlayerEvent>)
        RE::BSEventNotifyControl ProcessEvent(const PositionPlayerEvent* a_event,
                                              RE::BSTEventSource<PositionPlayerEvent>* a_eventSource)
        ...
        RE::ScrapHeap packedTaskHeap;                              // 038
		BSPackedTaskQueue            taskQueue;                    // 0C8
        RE::ScrapHeap secondaryPackedTaskHeap;                     // 108
